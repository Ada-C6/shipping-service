...
class ShipmentsController < ApplicationController
  ...
  def index
    begin
      ...
      render :json => {error: "UH-OH. LOOKS LIKE SOMETHING'S NOT QUITE RIGHT. PERHAPS YOUR ZIP CODES ARE OFF BY ONE? PLEASE NOTE: PACKAGES HAVE A WEIGHT LIMIT OF 150 LBS AND SHIPMENTS ARE ONLY ALLOWED WITHIN THE UNITED STATES."}, :status => '404'
